 ...
 * (rejected beyond now plus five minutes) while recordedAt stays a Postgres default; the {@link
 * Sleeper} backs the jittered serialization-retry backoff so tests can skip the sleep.
 */
@Configuration
