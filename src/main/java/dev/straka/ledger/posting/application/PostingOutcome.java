...
/**
 * Sealed interface describing one attempt's outcome: {@code Created} for a newly committed
 * posting, {@code Replayed} when the idempotency key already won. Success is visible to HTTP
 * only after commit.
 */
