...
/**
 * Opaque keyset cursor over (recordedAt, postingId, lineNumber): the immutable order entries are
 * listed in. Encoded base64url so clients treat it as opaque; any tampering fails parsing and the
 * request is rejected as malformed rather than silently restarting the listing.
 */
