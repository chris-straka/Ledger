...
projects:
  ...
  # Ledger repo (this repository). Only non-TODO lines below are true today;
  # every TODO line needs its PORT.md proof passing before it feeds the resume.
  - id: ledger
    name: "Double-Entry Ledger & Financial Integrity"
    context: "Personal Project"
    stack: "Java 25, Spring Boot 4.1, PostgreSQL 18, Docker"
    bullets:
      - id: ledger-scope
        track: both
        text: "Rebuilding a .NET telemetry repo into a single-ledger double-entry book of record in Java 25, Spring Boot, and Postgres, defining the accounting invariants and their tests before building features."
      - id: ledger-scaffold
        track: swe
